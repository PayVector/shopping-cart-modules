	   	...
	   	function toXMLString()
	   	{
	   		...
	   		if ($this->m_lspaSOAPParamAttributeList != null)
	   		{
	   			for ($nCount = 0; $nCount < $this->m_lspaSOAPParamAttributeList->getCount(); $nCount++)
	   			{
		   			...
		   			{
		   				$sbString = "";
		   				$sbString .= " " .$spaAttribute->getName(). "=\"" .\net\thepaymentgateway\common\SharedFunctions::replaceCharsInStringWithEntities($spaAttribute->getValue()). "\"";
	        ...
	        else
	        {
	        	...
	        	for ($nCount = 0; $nCount < $lszHierarchicalNames->getCount(); $nCount++)
	        	{
	        		// get the current tag name
	              	...
	              	//continuework
	               	$szTagNameToFind = \net\thepaymentgateway\common\SharedFunctions::getArrayNameAndIndex($szString, $nCurrentIndex);
