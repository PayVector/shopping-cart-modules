...
if (defined('DIR_EXTENSION')) {
	...
	require_once DIR_EXTENSION . 'payvector/catalog/controller/payment/lib/Config.php';
	...
	require_once DIR_SYSTEM . 'extension/payvector/catalog/controller/payment/lib/Config.php';
